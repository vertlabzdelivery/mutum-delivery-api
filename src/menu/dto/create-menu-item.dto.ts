...
class CreateMenuItemOptionDto {
  ...
  @Type(() => CreateMenuItemChoiceDto)
  choices?: CreateMenuItemChoiceDto[];
}
...
export { CreateMenuItemOptionDto, CreateMenuItemChoiceDto };
